              ...
              <li>
                <div class="about-slider">
                  <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                    <img src="{{ asset('motor/img/_MG_6313.jpg') }}" class="img-responsive" alt="Image">
                  </div>
                  <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 about-slider-description">
                    <h2 class="text-uppercase welcome-title">
                      <span class="welcome-title-1">BIODATA</span>
                    </h2>
                    <p class="welcome-message">
                        Nama Lengkap : Raviansyah Yudistira Pratama <br>
                        Tempat tanggal lahir : Jombang, 17 September 2001<br>
                        Jenis Kelamin : Laki-Laki<br>
                        Hobby : Volly<br>
                        Makanan favorit : Sate<br>
                        Minuman Favorit : Aqua</p>
                  </div>              
                </div>  
              </li>
              <li>
